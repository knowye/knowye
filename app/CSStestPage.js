/*
 * JS for CSStestPage generated by Appery.io
 */
...
function CSStestPage_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'mobilelabel_19': 'CSStestPage_mobilelabel_19',
        'testLabel': 'CSStestPage_testLabel',
        'testInput': 'CSStestPage_testInput',
        'testButton': 'CSStestPage_testButton',
        'testRadio': 'CSStestPage_testRadio',
        'testRadio2': 'CSStestPage_testRadio2',
        'testCheck': 'CSStestPage_testCheck',
        'mobilecheckbox_11': 'CSStestPage_mobilecheckbox_11',
        'testList': 'CSStestPage_testList',
        'mobilelistitem_15': 'CSStestPage_mobilelistitem_15',
        'mobilelistitembutton_16': 'CSStestPage_mobilelistitembutton_16',
        'testSelect': 'CSStestPage_testSelect',
        'testSelect-0': 'CSStestPage_testSelect-0',
        'testToggle': 'CSStestPage_testToggle',
        'mobilegrid_17': 'CSStestPage_mobilegrid_17',
        'mobilegridcell_18': 'CSStestPage_mobilegridcell_18',
        'testImage': 'CSStestPage_testImage'
    };
    ...
    Apperyio.CurrentScreen = 'CSStestPage';
     ...
     */
    // On Load
    var CSStestPage_onLoad = function() {
        CSStestPage_elementsExtraJS();
        CSStestPage_deviceEvents();
        CSStestPage_windowEvents();
        CSStestPage_elementsEvents();
    };
    // screen window events
    function CSStestPage_windowEvents() {
        $('#CSStestPage').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function CSStestPage_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function CSStestPage_elementsExtraJS() {
        // screen (CSStestPage) extra code
        /* testList */
        listView = $("#CSStestPage_testList");
        theme = listView.attr("data-theme");
        if (typeof theme !== 'undefined') {
            var themeClass = "ui-btn-up-" + theme;
            listItem = $("#CSStestPage_testList .ui-li-static");
        ...
        /* mobilelistitem_15 */
        /* testSelect */
        $("#CSStestPage_testSelect").parent().find("a.ui-btn").attr("tabindex", "7");
        /* testToggle */
        $("#CSStestPage_testToggle").parent().find(".ui-flipswitch-on").attr("tabindex", "4");
    };
    // screen elements handler
    function CSStestPage_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#CSStestPage").on("pagebeforeshow", "#CSStestPage", function(event, ui) {
        Apperyio.CurrentScreen = "CSStestPage";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#CSStestPage").on("pagecreate", "#CSStestPage", function(event, ui) {
