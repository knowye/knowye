/*
 * JS for easterEggPage generated by Appery.io
 */
...
function easterEggPage_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'navigateButton': 'easterEggPage_navigateButton',
        'easterEggImage': 'easterEggPage_easterEggImage'
    };
    ...
    Apperyio.CurrentScreen = 'easterEggPage';
     ...
     */
    // On Load
    var easterEggPage_onLoad = function() {
        easterEggPage_elementsExtraJS();
        easterEggPage_deviceEvents();
        easterEggPage_windowEvents();
        easterEggPage_elementsEvents();
    };
    // screen window events
    function easterEggPage_windowEvents() {
        $('#easterEggPage').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function easterEggPage_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function easterEggPage_elementsExtraJS() {
        // screen (easterEggPage) extra code
    };
    // screen elements handler
    function easterEggPage_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
        $(document).off("click", '#easterEggPage_easterEggHeader [name="navigateButton"]').on({
            click: function(event) {
                if (!$(this).attr('disabled')) {
                    navigateRB();
                }
            },
        }, '#easterEggPage_easterEggHeader [name="navigateButton"]');
    };
    $(document).off("pagebeforeshow", "#easterEggPage").on("pagebeforeshow", "#easterEggPage", function(event, ui) {
        Apperyio.CurrentScreen = "easterEggPage";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
    ...
    easterEggPage_onLoad();
};
$(document).off("pagecreate", "#easterEggPage").on("pagecreate", "#easterEggPage", function(event, ui) {
