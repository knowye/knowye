/*
 * JS for filterPage generated by Appery.io
 */
...
function filterPage_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'menuButton': 'filterPage_menuButton',
        'mobilelabel_2': 'filterPage_mobilelabel_2',
        'mobilelabel_3': 'filterPage_mobilelabel_3',
        'mobilelabel_4': 'filterPage_mobilelabel_4',
        'mobilelabel_5': 'filterPage_mobilelabel_5',
        'mobilelabel_6': 'filterPage_mobilelabel_6',
        'mobilelabel_7': 'filterPage_mobilelabel_7',
        'findDishesButton': 'filterPage_findDishesButton'
    };
    ...
    Apperyio.CurrentScreen = 'filterPage';
     ...
     */
    // On Load
    var filterPage_onLoad = function() {
        filterPage_elementsExtraJS();
        filterPage_deviceEvents();
        filterPage_windowEvents();
        filterPage_elementsEvents();
    };
    // screen window events
    function filterPage_windowEvents() {
        $('#filterPage').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function filterPage_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function filterPage_elementsExtraJS() {
        // screen (filterPage) extra code
    };
    // screen elements handler
    function filterPage_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
        $(document).off("click", '#filterPage_filterHeader [name="menuButton"]').on({
        ...
        }, '#filterPage_filterHeader [name="menuButton"]');
        $(document).off("click", '#filterPage_searchByContainer [name="findDishesButton"]').on({
            click: function(event) {
                if (!$(this).attr('disabled')) {
        ...
        }, '#filterPage_searchByContainer [name="findDishesButton"]');
    };
    $(document).off("pagebeforeshow", "#filterPage").on("pagebeforeshow", "#filterPage", function(event, ui) {
        Apperyio.CurrentScreen = "filterPage";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#filterPage").on("pagecreate", "#filterPage", function(event, ui) {
