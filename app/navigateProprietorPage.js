/*
 * JS for navigateProprietorPage generated by Appery.io
 */
...
function navigateProprietorPage_js() {
    ...
    Apperyio.CurrentScreen = 'navigateProprietorPage';
     ...
     */
    // On Load
    var navigateProprietorPage_onLoad = function() {
        navigateProprietorPage_elementsExtraJS();
        navigateProprietorPage_deviceEvents();
        navigateProprietorPage_windowEvents();
        navigateProprietorPage_elementsEvents();
    };
    // screen window events
    function navigateProprietorPage_windowEvents() {
        $('#navigateProprietorPage').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function navigateProprietorPage_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function navigateProprietorPage_elementsExtraJS() {
        // screen (navigateProprietorPage) extra code
    };
    // screen elements handler
    function navigateProprietorPage_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#navigateProprietorPage").on("pagebeforeshow", "#navigateProprietorPage", function(event, ui) {
        Apperyio.CurrentScreen = "navigateProprietorPage";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
    ...
    navigateProprietorPage_onLoad();
};
$(document).off("pagecreate", "#navigateProprietorPage").on("pagecreate", "#navigateProprietorPage", function(event, ui) {
    Apperyio.processSelectMenu($(this));
    navigateProprietorPage_js();
});