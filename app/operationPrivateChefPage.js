/*
 * JS for operationPrivateChefPage generated by Appery.io
 */
...
function operationPrivateChefPage_js() {
    ...
    Apperyio.CurrentScreen = 'operationPrivateChefPage';
     ...
     */
    // On Load
    var operationPrivateChefPage_onLoad = function() {
        operationPrivateChefPage_elementsExtraJS();
        operationPrivateChefPage_deviceEvents();
        operationPrivateChefPage_windowEvents();
        operationPrivateChefPage_elementsEvents();
    };
    // screen window events
    function operationPrivateChefPage_windowEvents() {
        $('#operationPrivateChefPage').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function operationPrivateChefPage_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function operationPrivateChefPage_elementsExtraJS() {
        // screen (operationPrivateChefPage) extra code
    };
    // screen elements handler
    function operationPrivateChefPage_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#operationPrivateChefPage").on("pagebeforeshow", "#operationPrivateChefPage", function(event, ui) {
        Apperyio.CurrentScreen = "operationPrivateChefPage";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
    ...
    operationPrivateChefPage_onLoad();
};
$(document).off("pagecreate", "#operationPrivateChefPage").on("pagecreate", "#operationPrivateChefPage", function(event, ui) {
    Apperyio.processSelectMenu($(this));
    operationPrivateChefPage_js();
});