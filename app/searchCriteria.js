/*
 * JS for searchCriteria generated by Appery.io
 */
...
function searchCriteria_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'navigateButton': 'searchCriteria_navigateButton'
    };
    ...
    Apperyio.CurrentScreen = 'searchCriteria';
     ...
     */
    // On Load
    var searchCriteria_onLoad = function() {
        searchCriteria_elementsExtraJS();
        searchCriteria_deviceEvents();
        searchCriteria_windowEvents();
        searchCriteria_elementsEvents();
    };
    // screen window events
    function searchCriteria_windowEvents() {
        $('#searchCriteria').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function searchCriteria_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function searchCriteria_elementsExtraJS() {
        // screen (searchCriteria) extra code
    };
    // screen elements handler
    function searchCriteria_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
        $(document).off("click", '#searchCriteria_searchCriteriaHeader [name="navigateButton"]').on({
        ...
        }, '#searchCriteria_searchCriteriaHeader [name="navigateButton"]');
    };
    $(document).off("pagebeforeshow", "#searchCriteria").on("pagebeforeshow", "#searchCriteria", function(event, ui) {
        Apperyio.CurrentScreen = "searchCriteria";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
    ...
    searchCriteria_onLoad();
};
$(document).off("pagecreate", "#searchCriteria").on("pagecreate", "#searchCriteria", function(event, ui) {
