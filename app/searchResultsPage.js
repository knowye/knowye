/*
 * JS for searchResultsPage generated by Appery.io
 */
...
function searchResultsPage_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'navigateButton': 'searchResultsPage_navigateButton'
    };
    ...
    Apperyio.CurrentScreen = 'searchResultsPage';
     ...
     */
    // On Load
    var searchResultsPage_onLoad = function() {
        searchResultsPage_elementsExtraJS();
        searchResultsPage_deviceEvents();
        searchResultsPage_windowEvents();
        searchResultsPage_elementsEvents();
    };
    // screen window events
    function searchResultsPage_windowEvents() {
        $('#searchResultsPage').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function searchResultsPage_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function searchResultsPage_elementsExtraJS() {
        // screen (searchResultsPage) extra code
    };
    // screen elements handler
    function searchResultsPage_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
        $(document).off("click", '#searchResultsPage_helpSearchResultsHeader [name="navigateButton"]').on({
        ...
        }, '#searchResultsPage_helpSearchResultsHeader [name="navigateButton"]');
    };
    $(document).off("pagebeforeshow", "#searchResultsPage").on("pagebeforeshow", "#searchResultsPage", function(event, ui) {
        Apperyio.CurrentScreen = "searchResultsPage";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
    ...
    searchResultsPage_onLoad();
};
$(document).off("pagecreate", "#searchResultsPage").on("pagecreate", "#searchResultsPage", function(event, ui) {
    Apperyio.processSelectMenu($(this));
    searchResultsPage_js();
});