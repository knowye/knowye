/*
 * JS for themeSample generated by Appery.io
 */
...
function themeSample_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'potImage': 'themeSample_potImage'
    };
    ...
    Apperyio.CurrentScreen = 'themeSample';
     ...
     */
    // On Load
    var themeSample_onLoad = function() {
        themeSample_elementsExtraJS();
        themeSample_deviceEvents();
        themeSample_windowEvents();
        themeSample_elementsEvents();
    };
    // screen window events
    function themeSample_windowEvents() {
        $('#themeSample').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function themeSample_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function themeSample_elementsExtraJS() {
        // screen (themeSample) extra code
    };
    // screen elements handler
    function themeSample_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#themeSample").on("pagebeforeshow", "#themeSample", function(event, ui) {
        Apperyio.CurrentScreen = "themeSample";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#themeSample").on("pagecreate", "#themeSample", function(event, ui) {
