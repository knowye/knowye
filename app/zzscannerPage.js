/*
 * JS for zzscannerPage generated by Appery.io
 */
...
function zzscannerPage_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'navigateButton': 'zzscannerPage_navigateButton',
        'mobileimage_4': 'zzscannerPage_mobileimage_4',
        'scanner': 'zzscannerPage_scanner'
    };
    ...
    Apperyio.mappings["zzscannerPage_scannerPage_mobilebarcode_onbeforesend_mapping_0"] = {
        "homeScreen": "zzscannerPage",
        "directions": []
    };
    Apperyio.datasources = Apperyio.datasources || {};
    window.scannerPage_mobilebarcode = Apperyio.datasources.scannerPage_mobilebarcode = new Apperyio.DataSource(zzBarcodeService, {
        "onBeforeSend": function(jqXHR) {
            Apperyio.processMappingAction(Apperyio.mappings["zzscannerPage_scannerPage_mobilebarcode_onbeforesend_mapping_0"]);
        },
    ...
    Apperyio.CurrentScreen = 'zzscannerPage';
     ...
     */
    // On Load
    var zzscannerPage_onLoad = function() {
        zzscannerPage_elementsExtraJS();
        initQRScaner();
        zzscannerPage_deviceEvents();
        zzscannerPage_windowEvents();
        zzscannerPage_elementsEvents();
    };
    // screen window events
    function zzscannerPage_windowEvents() {
        $('#zzscannerPage').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function zzscannerPage_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function zzscannerPage_elementsExtraJS() {
        // screen (zzscannerPage) extra code
    };
    // screen elements handler
    function zzscannerPage_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
        $(document).off("click", '#zzscannerPage_scanHeader [name="navigateButton"]').on({
        ...
        }, '#zzscannerPage_scanHeader [name="navigateButton"]');
    };
    $(document).off("pagebeforeshow", "#zzscannerPage").on("pagebeforeshow", "#zzscannerPage", function(event, ui) {
        Apperyio.CurrentScreen = "zzscannerPage";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
    ...
    zzscannerPage_onLoad();
};
$(document).off("pagecreate", "#zzscannerPage").on("pagecreate", "#zzscannerPage", function(event, ui) {
